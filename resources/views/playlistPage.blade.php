    ...
    <x-slot name="header">
        ...
        @foreach($playlist as $key => $data)
            <div class="rounded-3xl min-h-26 min-w-30 bg-blue-500 m-2 p-4 text-white">
                ...
                <x-jet-nav-link type="button" class='rounded-3xl bg-white hover:bg-white text-black font-bold py-2 px-4 m-2 rounded' href="{{ route('editPlaylist') }}"> edit playlist </x-jet-nav-link>
