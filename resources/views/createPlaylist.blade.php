<x-app-layout>
    <x-slot name="header">
      ...
      @csrf
    <form action="{{route('addPlaylist')}}" method="POST" class="grid place-items-center ">
        ...
        <div class="md:flex md:items-center">
          ...
          <div class="md:w-2/3">
            <button class="shadow bg-blue-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
              <x-jet-nav-link type="button" class='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded' href="{{ route('addPlaylist') }}"> maak playlist </x-jet-nav-link>
            </button>
          </div>
        </div>
      </form>
