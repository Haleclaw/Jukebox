<x-app-layout>
    ...
    <div class='content-center'>
        <div class='text-center rounded-3xl bg-white text-black font-bold py-2 px-4 m-2 rounded'>
            ...
            <x-jet-nav-link type="button" class='rounded-3xl bg-gray-50 text-black font-bold py-2 px-4 m-2 rounded' href="/addToQueue/{{$data->id}}"> Toevoegen aan Queue </x-jet-nav-link>
        </div>
    </div>
    @endforeach
